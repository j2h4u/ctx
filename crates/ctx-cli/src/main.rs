...
use work_record_core::{database_path, default_data_root, CaptureProvider, EventType, WorkRecord};
...
fn event_preview(event: &work_record_core::Event) -> String {
    ...
    event.payload.to_string().chars().take(120).collect()
}
