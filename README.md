...
The installer indexes discovered local history and installs the bundled
agent-history skill. To refresh or reinstall the skill later:
...
| [Install the ctx skill](https://ctx.rs/skill) | Install or refresh the bundled agent-history search skill. |
