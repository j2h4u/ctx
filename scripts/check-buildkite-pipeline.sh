...
validate_contract() {
  ...
  require_text "completion certificate downloads Linux release dry-run artifacts" "${pipeline}" 'buildkite-agent artifact download "artifacts/buildkite/release-dry-run/linux-x64/**/*" .'
  require_text "completion certificate downloads macOS arm64 release dry-run artifacts" "${pipeline}" 'buildkite-agent artifact download "artifacts/buildkite/release-dry-run/macos-arm64/**/*" .'
  require_text "completion certificate downloads macOS x64 release dry-run artifacts" "${pipeline}" 'buildkite-agent artifact download "artifacts/buildkite/release-dry-run/macos-x64/**/*" .'
  ...
  require_text "completion certificate downloads FreeBSD blocker artifact" "${pipeline}" 'buildkite-agent artifact download "artifacts/buildkite/release-blockers/freebsd-x64/**/*" .'
  require_text "completion certificate downloads provider fixture artifact" "${pipeline}" 'buildkite-agent artifact download "artifacts/buildkite/finished-product/provider-fixtures/**/*" .'
  require_text "completion certificate downloads rich search/context artifact" "${pipeline}" 'buildkite-agent artifact download "artifacts/buildkite/finished-product/rich-search-context/**/*" .'
  require_text "completion certificate downloads dashboard/report artifact" "${pipeline}" 'buildkite-agent artifact download "artifacts/buildkite/finished-product/dashboard-report-artifact-review/**/*" .'
  require_text "completion certificate downloads PR publish dry-run artifact" "${pipeline}" 'buildkite-agent artifact download "artifacts/buildkite/finished-product/pr-publish-dry-run/**/*" .'
  require_text "completion certificate downloads security archive fixture artifact" "${pipeline}" 'buildkite-agent artifact download "artifacts/buildkite/finished-product/security-archive-fixtures/**/*" .'
  require_text "completion certificate downloads jj blocker artifact" "${pipeline}" 'buildkite-agent artifact download "artifacts/buildkite/finished-product/jj-e2e-blocker-status/**/*" .'
