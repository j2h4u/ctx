...
validate_contract() {
  ...
  require_text "install metadata template records R2 prefix" "release/install/ctx-release-metadata.env.template" 'CTX_RELEASE_R2_PREFIX=work-recorder/ctx/release-candidate/v0.1.0/<git-commit>'
