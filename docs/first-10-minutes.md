...
Zed, Copilot CLI, Factory AI Droid, and Autohand Code. NanoClaw and AstrBot can
appear as preview rows when ctx can discover their local project or SQLite
paths. A row with `exists: false`
